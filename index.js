...
const APP_PORT = process.env.PORT || 3000; // (process.env.NODE_ENV === 'test' ? process.env.TEST_APP_PORT : process.env.APP_PORT) || process.env.PORT || '3000';
...
app.use(errorHandler.bodyParser); // app.use(json);
// API Routes
...
app.listen(APP_PORT, () => {
  _logger.default.info(`Server started at http://${app.get('host')}:${APP_PORT}/api`);
