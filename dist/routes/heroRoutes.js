...
router.post('/', _adminAuthenticate.default, _heroValidator.heroValidator, heroController.create);
/**
 * PUT /api/heroes/:id
 */

router.put('/:id', _adminAuthenticate.default, _heroValidator.findHero, _heroValidator.heroValidator, heroController.update);
/**
