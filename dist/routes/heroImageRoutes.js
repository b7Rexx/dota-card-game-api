...
router.post('/', _heroImageValidator.heroImageValidator, _upload.default.single('image'), function (req, res, next) {
...
router.put('/:id', _heroImageValidator.findHeroImage, _heroImageValidator.heroImageValidator, _upload.default.single('image'), function (req, res, next) {
  (0, _uploadImage.saveResizedImages)(req.body.image).then(filename => {
    req.body.image = `image_${filename}`;
    req.body.original = `original_${filename}`;
    req.body.thumbnail = `thumbnail_${filename}`;
